...
my $boat_data = [
	...
	{ row=>1,	col=>1,		name=>'water_temp',			type=>'Float',		prec=>1,	},
	{ row=>2,	col=>1,		name=>'heading',		 	type=>'Float',		prec=>1,	},
	{ row=>3,	col=>1,		name=>'water_speed',		type=>'Float',		prec=>1,	},
	{ row=>4,	col=>1,		name=>'current_set',		type=>'Float',		prec=>1,	},
	{ row=>5,	col=>1,		name=>'current_drift',		type=>'Float',		prec=>1,	},
	{ row=>6,	col=>1,		name=>'wind_angle',       	type=>'Float',		prec=>1,	},
	{ row=>7,	col=>1,		name=>'wind_speed',       	type=>'Float',		prec=>1,	},
	{ row=>8,	col=>1,		name=>'latitude',         	type=>'Double',		latlon=>1,	},
	{ row=>9,	col=>1,		name=>'longitude',        	type=>'Double',		latlon=>1,	},

	{ row=>11,	col=>1,		name=>'sog',		 		type=>'Float',		prec=>1,	},
	{ row=>12,	col=>1,		name=>'cog',				type=>'Float',		prec=>1,	},
	{ row=>13,	col=>1,		name=>'app_wind_angle',   	type=>'Float',		prec=>1,	},
	{ row=>14,	col=>1,		name=>'app_wind_speed',   	type=>'Float',		prec=>1,	},
	{ row=>15,	col=>1,		name=>'estimated_set',   	type=>'Float',		prec=>4,	},
	{ row=>16,	col=>1,		name=>'estimated_drift',   	type=>'Float',		prec=>4,	},
	{ row=>17,	col=>1,		name=>'cross_track_error',  type=>'Float',		prec=>4,	},
	{ row=>18,	col=>1,		name=>'closest',		    type=>'Uint16',		},
